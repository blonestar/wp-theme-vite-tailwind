...
<body <?php body_class('h-screen border') ?>>
    ...
    <div class="h-full border1 flex flex-wrap content-center">
        <div class="inline-block border mx-auto text-center px-8 py-4 rounded-3xl shadow-xl">
            ...
            <h2 class="text-xl font-bold text-black">Wordpress Theme rapid development</h2>
            ...
            <p class="mt-3 text-sm">After Vite is running you shoud see this formated and in the middle of the screen, if so try edditing index.php in this theme.</p>
        </div>
    </div>
